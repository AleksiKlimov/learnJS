// const createInterfaceField = (fullField, humanSea, ships) => {
//   for (let y = 0; y <= 9; y++) {
//     for (let x = 0; x <= 9; x++) {
...
//         : humanDiv;
//       // humanDiv.dataset.value <= 4 || humanDiv.dataset.value >= 1
//       // ? (humanDiv.dataset.id = shipsId)
//       // : shipsId;
//     }
//   }
// };
// // export { createInterfaceField };
